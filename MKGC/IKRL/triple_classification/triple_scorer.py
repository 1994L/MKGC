...
import numpy as np
import IKRL.triple_classification.helper_functions as u
import IKRL.triple_classification.parameters as p
...
entity_txt_embeddings = u.load_binary_file(p.text_entity_embeddings_file, 3)
entity_embeddings_img = u.load_binary_file(p.image_entity_embeddings_file, 3)
