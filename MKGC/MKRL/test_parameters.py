...
checkpoint_best_valid_dir = "./best_weight/(MKRL)1500_10_best_models_weights/best_"+model_id+"/"
...
checkpoint_current_dir ="./best_weight/(MKRL)1500_10_best_models_weights/current_"+model_id+"/"
...
# Results location
results_dir = "./best_weight/(MKRL)1500_10_best_models_weights/results_"+model_id+"/"
