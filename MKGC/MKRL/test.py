...
import MKRL.test_parameters as param
import MKRL.util as u
...
def predict_best_tail(test_triple, full_triple_list, full_entity_list, entity_embeddings_txt,
    ...
    for batch_i in range(total_batches):
        ...
        sub_predictions = predict_tail(head_embeddings_list_txt, head_embeddings_list_img, full_relation_embeddings,
...
print(str(tail_ma_raw) + "\t" + str(tail_ma_filter) + "\t" + str(tail_hits10_raw) + "\t" + str(
    tail_hits10_filter) + "\t" + str(tail_hits1_raw) + "\t" + str(tail_hits1_filter))

print("MA Raw Head \t MA Filter Head \t Hits10 Raw Head \t Hits10 Filter Head \t Hits1 Raw Tail \t Hits1 Fiilter Tail")
print(str(head_ma_raw) + "\t" + str(head_ma_filter) + "\t" + str(head_hits_raw) + "\t" + str(
    head_hits_filter) + "\t" + str(tail_hits1_raw) + "\t" + str(tail_hits1_filter))
...
print(str(avg_ma_raw) + "\t" + str(avg_ma_filter) + "\t" + str(avg_hits10_raw) + "\t" + str(
    avg_hits10_filter) + "\t" + str(avg_hits1_raw) + "\t" + str(avg_hits1_filter))