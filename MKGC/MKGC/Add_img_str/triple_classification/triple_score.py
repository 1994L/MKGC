...
import numpy as np
from MKGC.Add_img_str.triple_classification import helper_functions as u
from MKGC.Add_img_str.triple_classification import parameters as p
...
def calculate_triple_score(triple, rel_embd_dict, entity_structure_embd_dict, entity_image_embd_dict):
    head = triple[0]
    tail = triple[1]
    relation = triple[2]
