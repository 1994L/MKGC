...
with tf.name_scope('cosine'):
    ...
    h_fusion_mapped_pos = h_pos_structure_mapped + h_pos_image_mapped
    h_fusion_mapped_neg = h_neg_structure_mapped + h_neg_image_mapped

    t_fusion_mapped_pos = t_pos_structure_mapped + t_pos_image_mapped
    t_fusion_mapped_neg = t_neg_structure_mapped + t_neg_image_mapped
...
h_data_valid_structure, h_data_valid_image, r_data_valid, t_data_valid_structure, t_data_valid_image, \
t_neg_data_valid_structure, t_neg_data_valid_image, h_neg_data_valid_stucture, h_neg_data_valid_image = \
    ...
    for epoch in range(param.training_epochs):
       ...
       # training_data2 = training_data[:len(training_data)//3]
        ...
        for i in range(total_batch):
            ...
            h_data_structure, h_data_image, r_data, t_data_structure, \
            t_data_image, t_neg_data_structure, t_neg_data_image, \
            h_neg_data_structure, h_neg_data_image = u.get_batch_with_neg_heads_and_neg_tails_multimodal(
                training_data, triples_set, entity_list, start, end, entity_embeddings_structural,
                entity_embeddings_image)
