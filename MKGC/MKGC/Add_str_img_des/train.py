...
h_neg_data_valid_stucture, h_neg_data_valid_description, h_neg_data_valid_image = \
    ...
    for epoch in range(param.training_epochs):
       ...
       # training_data2 = training_data[:len(training_data)//3]
        ...
        for i in range(total_batch):
            ...
            h_neg_data_structure, h_neg_data_description, h_neg_data_image = u.get_batch_with_neg_heads_and_neg_tails_multimodal(
