...
import MKGC.Add_str_img_des.util as u
...
def predict_best_tail(test_triple, full_triple_list, full_entity_list,
    ...
    for batch_i in range(total_batches):
        ...
        sub_predictions = predict_tail(head_embeddings_list_structure, head_embeddings_list_description,
                                       head_embeddings_list_image, full_relation_embeddings,
...
def predict_tail(head_embedding_structure, head_embedding_description,head_embedding_image, relation_embedding,
                 tails_embedding_structure, tails_embedding_description, tails_embeddings_image):
...
def predict_head(tail_embeddings_list_structure, tail_embeddings_list_description, tail_embeddings_list_image,
                 full_relation_embeddings, heads_embeddings_list_structure, heads_embeddings_list_description, heads_embeddings_list_image):
...
def predict_best_head(test_triple, full_triple_list, full_entity_list, entity_embeddings_structure,
    ...
    for batch_i in range(total_batches):
        ...
        sub_predictions = predict_head(tail_embeddings_list_structure, tail_embeddings_list_description,
                                       tail_embeddings_list_image, full_relation_embeddings,
                                       heads_embeddings_list_structure, heads_embeddings_list_description, heads_embeddings_list_image)
...
with tf.Session(config=sess_config) as sess:
        ...
        for triple in all_test_triples:
            ...
            line = triple[1] + "\t" + triple[2] + "\t" + triple[0] + "\t" + str(top_10) + "\t" + str(
...
print(
    "MA Raw Tail \t MA Filter Tail \t Hits@10 Raw Tail \t Hits@10 Filter Tail \t Hits@1 Raw Tail \t Hits@1 Filter Tail")
...
print(
    "MA Raw Head \t MA Filter Head \t Hits@10 Raw Head \t Hits@10 Filter Head \t Hits@1 Raw Head \t Hits@1 Filter Head")
