...
import numpy as np
from MKGC.Add_str_img_des.triple_classification import helpaer_functions as u
...
def calculate_triple_score(triple, rel_embd_dict, entity_structure_embd_dict, entity_description_embd_dict, entity_image_embd_dict):
    head = triple[0]
    tail = triple[1]
    relation = triple[2]
