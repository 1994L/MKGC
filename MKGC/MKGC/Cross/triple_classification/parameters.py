import os
triple_classification_base_dir = "./data/WN9-D-IMG/result/"
...
multimodal_entity_embeddings_file = "./data/WN9-D-IMG/multimodal.pkl"




# weights files
checkpoint_best_valid_dir = "./best_weight/1500_11_best_models_weights/best_WN9D-IMG/"
best_valid_model_meta_file = checkpoint_best_valid_dir + "WN9D-IMG.meta"

model_name = "1500_4_HMS-03"
dataset = "WN9D-IMG"
