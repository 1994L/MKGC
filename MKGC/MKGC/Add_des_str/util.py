...
def load_entity_list(triple_file, entity_embeddings_structure, entity_embeddings_description):
    entity_list = []
    ...
    for line in lines:
        ...
        if head in entity_embeddings_structure and tail in entity_embeddings_structure and head in \
                entity_embeddings_description and tail in entity_embeddings_description:
            entity_list.append(head)
            entity_list.append(tail)
...
def load_freebase_triple_data_multimodal(train_triples_file, entity_embeddings_structural, entity_embeddings_description,
    ...
    for triple in training_triples:
        ...
        if head in entity_embeddings_structural and tail in entity_embeddings_structural and \
                head in entity_embeddings_description and tail in entity_embeddings_description:
            ...
            train_instance = (head_embd_structural, rel_embd, tail_embd_structural, head_embd_description,
                              tail_embd_description, head, rel, tail)
...
def get_batch_with_neg_heads_and_neg_tails_multimodal(training_data, triples_set, entity_list, start, end,
    ...
    return np.asarray(h_data_structure), np.asarray(h_data_description), np.asarray(r_data), \
           np.asarray(t_data_structure), np.asarray(t_data_description), \
           np.asarray(t_neg_data_structure), np.asarray(t_neg_data_description), \
           np.asarray(h_neg_data_structure), np.asarray(h_neg_data_description)
